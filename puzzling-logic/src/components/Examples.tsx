  ...
  const OssCirc = [
    {
      ...
      type: "NOT",
      src: NOTGate,
      x: (854 / 1920) * windowSize.width,
      y: (404 / 965) * windowSize.height,
    ...
    },
    {
      ...
      type: "NOT",
      src: NOTGate,
      x: (1000 / 1920) * windowSize.width,
      y: (461 / 965) * windowSize.height,
      addedToPlayArea: true,
      outputHigh: true,
      label: "",
    },
    {
      ...
      type: "NOT",
      src: NOTGate,
      x: (1127 / 1920) * windowSize.width,
      y: (523 / 965) * windowSize.height,
      addedToPlayArea: true,
      outputHigh: true,
      label: "",
    },
    {
      ...
      type: "LED",
      src: LEDOff,
      x: (1370 / 1920) * windowSize.width,
      y: (531 / 965) * windowSize.height,
      addedToPlayArea: true,
      outputHigh: false,
      label: "Output Signal",
    },
